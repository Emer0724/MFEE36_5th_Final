            ...
            return (
              <tr key={i} className={styles.Prodeucttr}>
                ...
                {v.status_id !== null ? (
                  <td className={styles.ProdeuctBlock}>
                    二手價
                    <span className={styles.usedprice}>${v.usedprice}</span>
                  </td>
                ) : (
                  <td className={styles.ProdeuctBlock}>
                ...
                <td>
                  {v.status_id !== null ? (
                    ...
                    <div className={styles.CountBlock}>
                      <button
                        style={Countcut}
                        className={styles.Countcut}
                        onClick={() => cutcount(v.ISBN, member1)}
                      >
                        -
                      </button>
                      <div className={styles.Countvalue}>{v.count}</div>
                      <button
                        ...
                        onClick={() => addcount(v.ISBN, member1)}
                      >
                        +
                      </button>
                    </div>
                ...
                <td className={styles.ProdeuctBlock}>
                  <button
                    ...
                    onClick={() => deleteitem(v.ISBN, v.status_id, member1)}
                  >
                    <Image src={Trash} width={40} height={40} alt="icon" />
                  </button>
                </td>
              </tr>
            )
