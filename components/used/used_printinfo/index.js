      ...
      <table className="table mt-3">
        ...
        <tbody>
          {usedPrintInfo.map((v, i) => {
            return (
              <tr key={v.used_id}>
                <th className="text-center used_chk_msg_td_center">{i + 1}</th>
                <td className="text-center used_chk_msg_td_center">
                  {v.used_id}
                </td>
                <td className="text-center used_chk_msg_td_center">{v.ISBN}</td>
