...
export default function UsedUpCheck({ postData, cancel_btn, print_btn }) {
  return (
    <div className={`w-50 px-5 py-5 ${css.border_card} used_display_chkbox `}>
      ...
      <div
        className={`textp-32px letter-spacing fw-bold ${css.text_line} text-center print_only   `}
      >
        上架資訊
      </div>
      <div
        className={`textp-20px mt-3 pb-1 letter-spacing ${css.text_line_sm} print_only `}
      >
      ...
      <div className={`textp-20px mt-3 pb-1 letter-spacing print_only `}>
