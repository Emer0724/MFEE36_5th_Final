  ...
  return (
    <div className={styles.Header}>
      <div className={styles.HeaderNavbar}>
        <Link href="#" className={styles.logolink}><Image src={logo} width={150} height={100} className={styles.logoimg} alt='icon'/></Link>
          ...
          {NavIcon.map((v,i)=>{
            return( 
                <Link href="#" className={styles.navlink2} key={i}>
                  <Image src={v} width={60} height={30} className={styles.Licon} alt='icon'/>
                </Link>
            )})}
        </div>
      </div>
