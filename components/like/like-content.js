...
export default function LikeContent() {
    ...
    return (
        <>
            ...
            <div className="pt-3">
                <Link href={blog} className="text-black text-decoration-none"><p>疫情好轉，各國開關，有些馬特市民外出遊走，也有的在自己的市內散步，不論你在哪裡，都有美麗的風景、交雜的心情，以及想要分享的事物。最近 Matty 發現很多市民不約而同的分享了他／她們散步的故事</p></Link>
            </div>
