          ...
          <div className="index-index-video-container">
            <div className="index-index-video">
              ...
              <div className=" d-flex flex-column justify-content-center align-items-center px-5 ">
                ...
                <div className=" textp-28px my-2 fw-bold color-tx-1 index-index-video-text-md letter-spacing ">
                  Book書易-延續書的意義
                </div>
                <div className=" textp-20px pt-3 index-index-video-text-sm color-tx-1 letter-spacing ">
